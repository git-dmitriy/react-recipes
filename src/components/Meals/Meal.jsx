...
export function Meal(props) {
  ...
  return (
    <>
      <li className='flex flex-col bg-yellow-200 rounded-lg p-4 m-2'>
        ...
        <div className='flex flex-col items-start mt-4'>
          ...
          <Link
            to={`/meal/${idMeal}`}
            className='p-2 leading-none rounded font-medium mt-3 bg-yellow-300 hover:bg-yellow-400 transition duration-200 text-xs uppercase'
          >
            Watch the recipe
          </Link>
        </div>
