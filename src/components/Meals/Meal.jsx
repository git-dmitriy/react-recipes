        ...
        <div className='flex flex-col items-start mt-4'>
          <div className='flex items-center justify-between w-full'>
            ...
            {!state.favorites.find((item) => item.idMeal === idMeal) ? (
              <button
                className='w-1/12 leading-none rounded font-medium bg-transparent hover:text-yellow-300 transition duration-200 text-xs uppercase'
                onClick={() => {
              ...
              <button
                className='w-1/12 leading-none rounded font-medium bg-transparent text-yellow-300 transition duration-200 text-xs uppercase'
                onClick={() => {
