...
export const CategoryItem: React.FC<CategoryItemTypes> = ({
    ...
    return (
        <Link
            ...
            className='h-full grid grid-rows-1 grid-cols-5 hover:opacity-90 focus-visible:opacity-90 transition-opacity rounded-3xl border border-gray-200 dark:border-gray-900 overflow-hidden bg-white dark:bg-orange-100 dark:text-gray-900 sm:mx-0 min-h-170p'
        >
