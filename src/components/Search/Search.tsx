        ...
        <form className='flex' onSubmit={onSubmitHanlder}>
            <div className='relative my-2 mx-auto dark:text-gray-900'>
                <input
                    role='searchbox'
                    type='text'
                    className='focus:outline-hidden focus:ring-2 dark:placeholder:text-gray-600 bg-gray-100 focus:ring-red-500 shadow-xs rounded-full w-52 sm:w-60 md:w-72 lg:w-80 xl:w-96 border-0 p-3 pl-9 min-w-full'
