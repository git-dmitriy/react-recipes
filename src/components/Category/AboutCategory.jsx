const AboutCategory = ({ categoryInfo }) => {
  ...
  return (
    <div className='hidden sm:block mx-auto px-4 xl:max-w-6xl max-w-4xl'>
      <div className='flex bg-yellow-100 rounded-lg p-4 m-2'>
        ...
        <div className='sm:w-2/4 w-3/5 flex flex-col items-start ml-4 border-l-2 border-yellow-300 pl-4'>
